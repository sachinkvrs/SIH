...
export default function LandingPage({ onNavigate }) {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-slate-800 flex flex-col font-sans">
        ...
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-xs font-medium text-slate-600">
            <button
              ...
              className={`transition font-semibold ${
                activeSection === "home" ? "text-blue-600 font-bold" : "hover:text-slate-900"
              }`}
            >
              Home
            </button>
            <button
              ...
              className={`transition font-semibold ${
                activeSection === "about" ? "text-blue-600 font-bold" : "hover:text-slate-900"
              }`}
            >
              About
            </button>
            <button
              ...
              className={`transition font-semibold ${
                activeSection === "features" ? "text-blue-600 font-bold" : "hover:text-slate-900"
              }`}
            >
              Features
            </button>
            <button
              ...
              className={`transition font-semibold ${
                activeSection === "how-it-works" ? "text-blue-600 font-bold" : "hover:text-slate-900"
              }`}
            >
              How It Works
            </button>
            <button
              ...
              className={`transition font-semibold ${
                activeSection === "contact" ? "text-blue-600 font-bold" : "hover:text-slate-900"
              }`}
            >
              Contact
            </button>
          ...
          <div className="hidden md:flex items-center gap-3">
            <button
              ...
              className="px-4 py-1.5 text-xs font-semibold text-slate-700 hover:text-blue-600 border border-slate-300 rounded-lg hover:border-blue-500 transition cursor-pointer"
            >
              Login
            </button>
            <button
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <div className="flex flex-wrap items-center gap-3 pt-1">
              ...
              <button
                ...
                className="px-5 py-2.5 text-xs sm:text-sm font-semibold text-slate-700 bg-white border border-slate-300 hover:border-blue-400 hover:text-blue-600 rounded-lg shadow-xs transition cursor-pointer"
              >
          ...
          <div className="lg:col-span-6 relative">
            <div className="relative rounded-2xl overflow-hidden shadow-lg border border-slate-200/80 bg-white">
              ...
              {/* Floating Badge */}
              <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-md px-3.5 py-2 rounded-xl shadow-md border border-white/40 text-[11px] font-semibold text-slate-800 flex items-center gap-2">
          ...
          {audienceCards.map((card, idx) => {
            ...
            return (
              <div
                ...
                className="bg-white rounded-xl p-5 border border-slate-200/80 shadow-xs hover:shadow-md hover:-translate-y-0.5 transition-all cursor-pointer flex flex-col justify-between group"
              >
                <div>
                ...
                <div className="pt-4 flex items-center text-blue-600 text-xs font-semibold group-hover:translate-x-1 transition">
      ...
      <section id="about" className="bg-white border-y border-slate-200/80 py-10 px-6 scroll-mt-20">
        <div className="max-w-6xl mx-auto text-center space-y-6">
          <div>
            <span className="text-[11px] font-bold text-blue-600 tracking-wider uppercase bg-blue-50 px-3 py-1 rounded-full border border-blue-100">
              About SkillBridge
            </span>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 pt-4">
            <div className="border-r last:border-none border-slate-100">
              <div className="text-2xl sm:text-3xl font-extrabold text-slate-900">10K+</div>
              <div className="text-xs text-slate-500 font-medium mt-0.5">Students</div>
            </div>
            <div className="border-r last:border-none border-slate-100">
              <div className="text-2xl sm:text-3xl font-extrabold text-slate-900">500+</div>
              <div className="text-xs text-slate-500 font-medium mt-0.5">Industry Partners</div>
            </div>
            <div className="border-r last:border-none border-slate-100">
              <div className="text-2xl sm:text-3xl font-extrabold text-slate-900">1K+</div>
              <div className="text-xs text-slate-500 font-medium mt-0.5">Internship Opportunities</div>
            </div>
            <div>
              <div className="text-2xl sm:text-3xl font-extrabold text-slate-900">200+</div>
              <div className="text-xs text-slate-500 font-medium mt-0.5">Colleges</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="how-it-works" className="py-12 px-6 max-w-7xl mx-auto w-full scroll-mt-20">
        <div className="bg-[#0B1727] rounded-2xl p-8 sm:p-10 text-white shadow-xl">
      ...
      <section id="contact" className="py-12 px-6 max-w-7xl mx-auto w-full scroll-mt-20">
        <div className="bg-white rounded-2xl p-8 sm:p-10 border border-slate-200/80 shadow-xs">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-5 space-y-4">
              ...
              <div className="space-y-3 pt-2 text-xs text-slate-700">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <span className="block font-semibold text-slate-800">Email Us</span>
                    <a href="mailto:support@skillbridge.edu.in" className="text-blue-600 hover:underline">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <span className="block font-semibold text-slate-800">Toll Free Support</span>
                    <span className="text-slate-600">+91 1800-123-SKILL (Mon-Sat, 9AM-6PM)</span>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <span className="block font-semibold text-slate-800">National Headquarters</span>
                    <span className="text-slate-600">New Delhi, Innovation Hub, India</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 bg-slate-50 rounded-xl p-6 border border-slate-200">
              <h3 className="text-sm font-bold text-slate-900 mb-1">Send us an Inquiry</h3>
              <p className="text-xs text-slate-500 mb-4">Fill out the quick form and our academic-industry relations officer will respond within 24 hours.</p>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 text-xs bg-white border border-slate-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-blue-500 text-slate-800"
                      />
                    </div>
                    <div>
